...
class SkillLessonStaffForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "image_url": forms.URLInput(attrs={"class": "staff-input", "placeholder": "https://images.unsplash.com/..."}),
            "image_credit": forms.TextInput(attrs={"class": "staff-input", "placeholder": "Photo by Jane Doe on Unsplash"}),
